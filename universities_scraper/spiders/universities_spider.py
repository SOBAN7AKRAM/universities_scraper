...
class UniversitiesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "https://www.port.ac.uk/about-us/structure-and-governance/our-people/our-staff"
        ]    
        ...
        try:
            ...
            try:
                cookie_accept = await page.wait_for_selector(
                    "span.cf1y60",  # Cookie accept button selector
                    state="visible",
                    timeout=10000
                )
            ...
            while True:
                ...
                try:
                    ...
                    #         return lastCard?.offsetParent !== null;
                    #     }""",
                    #     timeout=20000
                    # )
                    await page.wait_for_timeout(20000)  # Wait for new content to load
