...
class UelSpider(scrapy.Spider):
    name = "uel_spider"
    
    def __init__(self, name=None, **kwargs):
        super().__init__(name, **kwargs)  # Ensure proper superclass initialization
        self.base_url = "https://www.uel.ac.uk/"
        self.start_url = "https://www.uel.ac.uk/site-search"
        self.output_folder = "urls"
        self.html_filename = "uel.txt"
    ...
    def start_requests(self):
        yield Request(
            url=urljoin(self.start_url, "?search_text=&search_category_type=people&items_per_page=50"),
            callback=self.parse,
            meta={
                "playwright": True,
    ...
    async def parse(self, response):
        ...
        try:
            ...
            for element in profile_links_elements:
                ...
                if href and href.startswith("/about-uel/staff"):
            ...
            next_page_element = soup.select_one("a[aria-label='Next Page']")
