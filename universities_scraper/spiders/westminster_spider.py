...
class WestminsterSpider(scrapy.Spider):
    name = "westminster_spider"
    
    def __init__(self, name=None, **kwargs):
        super().__init__(name, **kwargs)  # Ensure proper superclass initialization
        self.base_url = "https://www.westminster.ac.uk/"
        self.start_url = "https://www.westminster.ac.uk//about-us/our-people/academic-directory"
        self.output_folder = "urls"
        self.html_filename = "westminster.txt"
    ...
    def start_requests(self):
        yield Request(
            url=urljoin(self.start_url, "?type%5B0%5D=type%3A5676"),
            callback=self.parse,
            meta={
                "playwright": True,
    ...
    async def parse(self, response):
        ...
        try:
            ...
            profile_links_elements = soup.select(".views-row a")
