...
class ExeterSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = [
            "https://education.exeter.ac.uk/people/academic/",
            "https://spspa.exeter.ac.uk/people/academic/",
            "https://english.exeter.ac.uk/people/academic/",
            "https://business-school.exeter.ac.uk/people/academic/",
            "https://biosciences.exeter.ac.uk/people/academic/",
            "https://hcp.exeter.ac.uk/people/academicstaff/",
            "https://psychology.exeter.ac.uk/people/academic/",
        ]
    ...
    async def extract_emails(self, response):
        ...
        try:
            ...
            for email in current_emails:
                yield {"email": email, "university": "exeter.ac.uk"}
