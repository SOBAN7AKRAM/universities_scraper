...
class NorthumbriaSpider(scrapy.Spider):
    name = "northumbria_spider"
    
    def __init__(self, *args, **kwargs):
        # Starting URL for crawling
        self.start_url = "https://www.northumbria.ac.uk/"
        # Folder and filename where email elements HTML will be stored
        self.output_folder = "output"
        self.html_filename = "northumbria.html"
    ...
    def start_requests(self):
        yield Request(
            url=urljoin(self.start_url, "about-us/our-staff/#result-listing"),
    ...
    async def extract_emails(self, response):
        ...
        try:
            ...
            next_page_element = await page.query_selector('.next')
    ...
    def closed(self, reason):
        ...
        if os.path.exists(file_path):
            ...
            csv_file = os.path.join("emails", "northumbria.ac.uk_emails.csv")
