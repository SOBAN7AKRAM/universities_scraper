...
class LsbuSpider(scrapy.Spider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        self.base_url = "https://www.lsbu.ac.uk/_old/about-us/people/people-finder"
        self.output_folder = "urls"
        self.html_filename = "lsbu.txt"
    ...
    async def parse(self, response):
        ...
        try:
            ...
            for element in profile_links_elements:
                ...
                if href and href.startswith("https://www.lsbu.ac.uk/_old/about-us/people/people-finder/"):
            ...
            next_page_element = soup.find("a", text="Next")
