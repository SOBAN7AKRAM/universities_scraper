...
class YorksjSpider(scrapy.Spider):
    name = "yorksj_spider"
    
    def __init__(self, *args, **kwargs):
        # Starting URL for crawling
        self.start_url = "https://www.yorksj.ac.uk/our-staff/"
    ...
    async def extract_emails(self, response):
        ...
        try:
            ...
            for email in emails:
                yield {"email": email, "university": "yorksj.ac.uk"}
            
            
            # Look for the pagination next-page element.
            next_page_element = await page.query_selector('a[rel="next"]')
