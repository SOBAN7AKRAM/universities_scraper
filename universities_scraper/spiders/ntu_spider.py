...
class NtuSpider(scrapy.Spider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        self.base_url = "https://www.ntu.ac.uk/about-us/staff-directory"
        self.output_folder = "urls"
        self.html_filename = "ntu.txt"
    ...
    async def parse(self, response):
        ...
        try:
            while True:
                ...
                profile_links_elements = soup.select(".finder-results a")
                ...
                button = await page.query_selector("a.more-results")
                if button:
                    await button.click()
                else:
                    break
