...
class NclSpider(scrapy.Spider):
    name = "ncl_spider"
    
    def __init__(self, *args, **kwargs):
        # Starting URL for crawling
        self.start_url = "https://www.ncl.ac.uk/numed/people/"
        # Folder and filename where email elements HTML will be stored
        self.output_folder = "output"
        self.html_filename = "ncl.html"
    ...
    def start_requests(self):
        yield Request(
            ...
            meta={
                ...
                "next_url": "https://www.ncl.ac.uk/singapore/staff/"
            },
        )
    ...
    async def extract_emails(self, response):
        ...
        try:
            ...
            next_page = response.meta.get("next_url")
            if next_page:
                    yield Request(
                        url=next_page,
                        callback=self.extract_emails,
    ...
    def closed(self, reason):
        ...
        if os.path.exists(file_path):
            ...
            csv_file = os.path.join("emails", "ncl.ac.uk_emails.csv")
