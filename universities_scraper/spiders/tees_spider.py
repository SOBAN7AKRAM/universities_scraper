...
class TeesSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.start_url = "https://research.tees.ac.uk/"
        super().__init__(*args, **kwargs)
    
    def start_requests(self):
        yield Request(
            url=urljoin(self.start_url, "en/organisations/teesside-university/persons/"),
    ...
    async def extract_emails(self, response):
        ...
        try:
            ...
            for email in emails:
                yield {"email": email, "university": "tees.ac.uk"}
