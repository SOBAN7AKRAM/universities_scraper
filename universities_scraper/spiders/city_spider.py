...
class CitySpider(scrapy.Spider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        self.base_url = "https://www.city.ac.uk/about/people/academics"
        self.output_folder = "urls"
        self.html_filename = "city.txt"
    ...
    async def parse(self, response):
        ...
        try:
            ...
            profile_links_elements = soup.select(".card--profile a")
            ...
            next_page_element = soup.select_one("a.pagination__controls__button--next")
