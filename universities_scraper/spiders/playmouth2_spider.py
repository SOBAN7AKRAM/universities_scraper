...
class Playmouth2Spider(scrapy.Spider):
    name = "playmouth2_spider"

    def __init__(self, *args, **kwargs):
        self.output_folder = "urls"
        self.html_filename = "playmouth.txt"
    ...
    def start_requests(self):
        ...
        first_url = self.profile_links[1250]
        remaining_urls = self.profile_links[1251:]
        ...
        try:
            ...
            if element:
                ...
                if email not in self.seen_emails:
                    ...
                    yield {"email": email, "university": "playmouth1.ac.uk"}
