...
class YorkSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = [
            "https://www.york.ac.uk/business-society/people/",
            "https://www.york.ac.uk/english/people/",
            "https://www.york.ac.uk/arts-creative-technologies/people/",
            "https://www.york.ac.uk/biology/people/",
        ]
    ...
    async def extract_emails(self, response):
        ...
        try:
            ...
            for email in emails:
                yield {"email": email, "university": "york.ac.uk"}
