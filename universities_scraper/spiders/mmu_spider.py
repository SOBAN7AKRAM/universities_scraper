...
class mmuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield Request(
            url=urljoin(self.base_url, "about-us/faculties/science-engineering/staff"),
            callback=self.parse,
            meta={
                "playwright": True,
    ...
    async def parse(self, response):
        ...
        try:
            ...
            for element in profile_links_elements:
                ...
                if href and href.startswith("/about-us/faculties/science-engineering/staff/profile/"):
