...
class ShuSpider(scrapy.Spider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        self.base_url = "https://www.shu.ac.uk/about-us/our-people/staff-profiles"
        self.output_folder = "urls"
        self.html_filename = "shu.txt"
    ...
    async def parse(self, response):
        ...
        try:
            ...
            for element in profile_links_elements:
                ...
                if href and href.startswith("https://www.shu.ac.uk/about-us/our-people/staff-profiles"):
