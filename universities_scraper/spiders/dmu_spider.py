...
class DmuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield Request(
            url=urljoin(self.base_url, "research/research-staff.aspx"),
            callback=self.parse,
            meta={
                "playwright": True,
    ...
    async def parse(self, response):
        ...
        try:
            ...
            for element in profile_links_elements:
                ...
                if href and href.startswith("/about-dmu/academic-staff"):
            ...
            next_page_element = soup.find("a", title="Go to the next page of the Generic List")
